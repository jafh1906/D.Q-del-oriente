      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="pl-4.5 text-gray-600">
              Cuidamos tu salud y bienestar con agua pura y piscinas impecables,
              brindando servicio confiable, profesional y de alta calidad siempre.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              Distribución química del oriente S.A.S ©
            </p>
            <p className="text-gray-600 text-sm">
              Todos los derechos reservados {new Date().getFullYear()}
            </p>
